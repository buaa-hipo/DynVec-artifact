...
print( map_our_num )
print 'csr5', csr5_i , csr5_speed_up / csr5_i , 1.0 * csr5_i / map_our_num

print 'mkl', mkl_i , mkl_speed_up / mkl_i , 1.0 * mkl_i / map_our_num
print 'icc', icc_i , icc_speed_up / icc_i , 1.0 * icc_i / map_our_num
